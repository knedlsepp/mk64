...
SRC_DIRS       := src src/data src/buffers src/racing src/ending src/audio src/debug src/os src/unfloader_debug src/os/math courses assets/code/ceremony_data assets/code/startup_logo $(SRC_ASSETS_DIR)
